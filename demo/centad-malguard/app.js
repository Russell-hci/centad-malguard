const ASSET_ROOT = "../../results/gradcam/cenTaD_malguard_gradcam";
...
const STAGE_COPY = {
  ...
  4: {
    ...
    copy:
      "The defense uses the PGD-adversarially-trained MobileNetV3 checkpoint from the finalized experiment set.",
    next: "Check recovery",
  },
  5: {
...
init().catch((error) => {
  document.body.innerHTML = `<main class="load-error">
    <h1>CenTaD-MalGuard failed to load</h1>
    <p>${error.message}</p>
